...
input_file = os.path.join("CSV-Resources", "budget_data.csv")
...
print(f"Greatest Increase in Profits: {sum_months[max_increase_month]} (${(str(max_increase_value))})")
print(f"Greatest Decrease in Profits: {sum_months[max_decrease_month]} (${(str(max_decrease_value))})")
...
# Write methods to print to Financial_Analysis 
    ...
    file.write(f"Greatest Increase in Profits: {sum_months[max_increase_month]} (${(str(max_increase_value))})\n")
    file.write(f"Greatest Decrease in Profits: {sum_months[max_decrease_month]} (${(str(max_decrease_value))})\n")
